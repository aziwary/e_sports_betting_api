...
def train_test_split(data, percent_of_train_data = 0.9):
...
if __name__ == '__main__':
    ...
    recent_data = pd.read_csv('data/2023_LoL_esports_Data.csv', parse_dates=['date'])
    ...
    updated_df = pd.concat([recent_data, user_df])

    data = preprocess(updated_df)
