...
def features(df_2021, df_2022, df_2023_updated, champions_wr_overview):
    ...
    """
    from prediction_model.ml_logic.parameters.winrate import get_winrates
    from prediction_model.ml_logic.parameters.gspd import get_gspd
    from prediction_model.ml_logic.parameters.streak import get_streak
    from prediction_model.ml_logic.parameters.chmp_wr import get_chmp_wr
